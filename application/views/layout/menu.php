                ...
                <nav class="navbar">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <!-- LAYANAN -->
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Cabang Olahraga<span class="caret"></span></a>
                                <ul class="dropdown-menu sub-menu">
                            ...
                            <!-- PROFIL -->
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">TENTANG PORDASI<span class="caret"></span></a>
                                <ul class="dropdown-menu sub-menu">
                                    ...
                                    <li class="sub-active"><a href="<?php echo base_url('asosiasi') ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Asosiasi</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu sub-menu">
                                    ...
                                    <li class="sub-active"><a href="<?php echo base_url('agenda'); ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Galeri Agenda</a></li>
                                </ul>
                            </li>
