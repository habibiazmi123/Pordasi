...
<style type="text/css" media="screen">
  ...
  /* Hasil Pertandingan Style */

  .hasil-pertandingan__slick .item-pertandingan__box {
...
<!-- Slick -->
<script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/slickjs/slick-min.js"></script>
<script>
  $(function() {
    $("#example1").DataTable();
  });
