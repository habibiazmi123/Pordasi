      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          <a href="#" class="nav-link">
            ...
            <p>Biografi <i class="right fa fa-angle-left"></i></p>
          </a>
          <ul class="nav nav-treeview">
            <li class="nav-item"><a href="<?php echo base_url('admin/biografi') ?>" class="nav-link"><i class="fa fa-table nav-icon"></i>
                <p>Biografi</p>
              </a>
            </li>
            <li class="nav-item"><a href="<?php echo base_url('admin/biografi/tambah') ?>" class="nav-link"><i class="fa fa-plus nav-icon"></i>
                <p>Tambah Biografi</p>
              </a>
            </li>
            <li class="nav-item"><a href="<?php echo base_url('admin/jabatan') ?>" class="nav-link"><i class="fa fa-tags nav-icon"></i>
                <p>Jabatan</p>
              </a>
            </li>
