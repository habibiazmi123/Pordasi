<?php
echo form_open(base_url('admin/jabatan/proses'));
?>
<p class="btn-group">
    <a href="<?php echo base_url('admin/jabatan/tambah') ?>" class="btn btn-success btn-lg">
        ...
        <tbody>
            ...
            foreach ($jabatan as $result) { ?>
                ...
                <tr class="odd gradeX">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="<?php echo base_url('admin/jabatan/edit/' . $result['id']) ?>" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a>

                            <a href="<?php echo base_url('admin/jabatan/delete/' . $result['id']) ?>" class="btn btn-danger btn-xs " onclick="confirmation(event)"><i class="fa fa-trash-o"></i></a>
                        </div>
                    </td>
                </tr>
